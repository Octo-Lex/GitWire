...
const AUDIT = {
  ...
  audit_trail_entries: [
    { file: "services/aiReviewService.js", line: 498, func: "reviewPR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "gitwire[bot]", classification: "worker_auth_context" },
    { file: "services/aiReviewService.js", line: 512, func: "reviewPR gate block", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "gitwire[bot]", classification: "worker_auth_context" },
