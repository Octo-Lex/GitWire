...
const AUDIT = {
  decision_log: [
    ...
    { file: "workers/triageWorker.js", line: 70, func: "triageIssue failure handler", principalIdExpr: "not passed (null)", contextSource: "job data (failure handler — principalId not in scope after throw)", legacyActor: "issue.user.login", classification: "explicit_compatibility_gap" },
    { file: "workers/triageWorker.js", line: 148, func: "triageIssue", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "issue.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 162, func: "triageIssue", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "issue.user.login", classification: "worker_auth_context" },
    ...
    { file: "workers/triageWorker.js", line: 258, func: "triageIssue label recovery", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "issue.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 321, func: "triageIssue", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "issue.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 469, func: "triagePR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "pr.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 483, func: "triagePR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "pr.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 498, func: "triagePR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "pr.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 556, func: "triagePR label recovery", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "pr.user.login", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 589, func: "triagePR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "pr.user.login", classification: "worker_auth_context" },
  ...
  audit_trail_entries: [
    { file: "services/aiReviewService.js", line: 732, func: "reviewPR", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "gitwire[bot]", classification: "worker_auth_context" },
    { file: "services/aiReviewService.js", line: 746, func: "reviewPR gate block", principalIdExpr: "principalId", contextSource: "adoptWorker context", legacyActor: "gitwire[bot]", classification: "worker_auth_context" },
  ...
  managed_actions: [
    ...
    { file: "workers/triageWorker.js", line: 268, func: "triageIssue labelAction", principalIdExpr: "principalId", contextSource: "adoptWorker evidence context", legacyActor: "n/a", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 373, func: "triageIssue commentAction", principalIdExpr: "principalId", contextSource: "adoptWorker evidence context", legacyActor: "n/a", classification: "worker_auth_context" },
    { file: "workers/triageWorker.js", line: 565, func: "triagePR sizeAction", principalIdExpr: "principalId", contextSource: "adoptWorker evidence context", legacyActor: "n/a", classification: "worker_auth_context" },
  ],
};
