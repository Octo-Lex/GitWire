...
export const CONSEQUENTIAL_SURFACE_MANIFEST = Object.freeze([
  ...
  route("POST", "/api/actions", "/:id/retry", S.s6, P.p2, T.t1, V.r6, "actions.retry"),
  route("POST", "/api/actions", "/:id/cancel", S.s6, P.p2, T.t1, V.r6, "actions.cancel"),
  route("POST", "/api/actions", "/:id/reconcile", S.s6, P.p2, T.t1, V.r6, "actions.reconcile"),
  ...
  runtime("worker:sync", "worker", P.p0, T.t4, "worker-context", "system", V.r27, "repository.sync.worker"),
  runtime("worker:maintainer", "worker", P.p1, T.t1, "worker-context", "system", V.r28, "maintainer.worker"),
  runtime("worker:issueFix", "worker", P.p15, T.t1, "worker-context", "system", V.r29, "issue_fix.worker"),
  runtime("worker:phase2", "worker", P.p7, T.t1, "worker-context", "system", V.r30, "phase2.worker"),
  runtime("worker:phase3", "worker", P.p0, T.t4, "worker-context", "system", V.r31, "phase3.worker"),
  runtime("worker:phase4", "worker", P.p9, T.t1, "worker-context", "system", V.r32, "phase4.worker"),
  runtime("scheduled:sync", "scheduled", P.p0, T.t0, "worker-context", "system", V.r33, "sync.schedule"),
  runtime("scheduled:maintainer", "scheduled", P.p1, T.t4, "worker-context", "system", V.r34, "maintainer.schedule"),
  runtime("scheduled:phase3", "scheduled", P.p0, T.t0, "worker-context", "system", V.r35, "phase3.schedule"),
  runtime("scheduled:phase4", "scheduled", P.p9, T.t0, "worker-context", "system", V.r36, "phase4.schedule"),
  runtime("scheduled:reconciliation", "scheduled", P.p0, T.t0, "worker-context", "system", V.r37, "reconciliation.schedule"),
