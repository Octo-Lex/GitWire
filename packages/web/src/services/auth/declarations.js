...
const ROUTE_SURFACES = [
  ...
  R("route:POST:/api/actions/:id/retry", P.p2, T.t1, V.r6, "actions.retry"),
  R("route:POST:/api/actions/:id/cancel", P.p2, T.t1, V.r6, "actions.cancel"),
  R("route:POST:/api/actions/:id/reconcile", P.p2, T.t1, V.r6, "actions.reconcile"),
