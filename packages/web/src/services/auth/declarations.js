...
const ROUTE_SURFACES = [
  ...
  { id: "route:GET:/api/policy/change-requests/:id/approvals", kind: "route", permission: "policy_approval_rule:read", resourceType: "policy_definition", principalSource: "req.auth", authMethod: "api_key", observeHandling: "record" },
  { id: "route:GET:/api/policy/change-requests/:id/approvals/evaluate", kind: "route", permission: "policy_approval_rule:read", resourceType: "policy_definition", principalSource: "req.auth", authMethod: "api_key", observeHandling: "record" },
